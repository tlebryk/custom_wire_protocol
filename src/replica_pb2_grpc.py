...
class ReplicaServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.DeleteMessage = channel.unary_unary(
                ...
                response_deserializer=replica__pb2.WriteOperationResponse.FromString,
                _registered_method=True)
        self.GetReplicaID = channel.unary_unary(
                '/messaging.replica.ReplicaService/GetReplicaID',
                request_serializer=replica__pb2.GetReplicaIDRequest.SerializeToString,
                response_deserializer=replica__pb2.GetReplicaIDResponse.FromString,
                _registered_method=True)
...
def add_ReplicaServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetReplicaID': grpc.unary_unary_rpc_method_handler(
                    servicer.GetReplicaID,
                    request_deserializer=replica__pb2.GetReplicaIDRequest.FromString,
                    response_serializer=replica__pb2.GetReplicaIDResponse.SerializeToString,
            ),
...
class ReplicaService(object):
    ...
    def GetReplicaID(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/messaging.replica.ReplicaService/GetReplicaID',
            replica__pb2.GetReplicaIDRequest.SerializeToString,
            replica__pb2.GetReplicaIDResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
